# ArtGallery database
This is a school project for NoSQL databases. This database is meant for Neo4j and the main idea is to show artists, their art (what type of art etc.) and what museum has which art.

## How to get this database running
You will need to download [Docker Desktop](https://www.docker.com/products/docker-desktop/)

After you have downloaded it, go in command line and find this repository docker folder. It has yml file that connects to the neo4j.
...
Now this next part, go to the file names "query.cypher". There you can find some use cases I thought for this database and couple of editing queries. Just copy them one by one and paste into the Neo4j.
